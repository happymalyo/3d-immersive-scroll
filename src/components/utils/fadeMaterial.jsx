...
GLSL : OpenGl, Shader Language for shading material using inputs(Fragment shader)
This exponential shaping function is from: http://www.flong.com/archive/index.html
